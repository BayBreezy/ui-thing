---
title: MCP Server
description: Connect UI Thing to Codex, VS Code, and other MCP clients for scaffold-first access to components, blocks, docs, and install plans.
---
...
- small discovery indexes for components, blocks, docs, examples, and page templates
...
5. Call `get-component`, `get-block`, or `get-documentation-page`
