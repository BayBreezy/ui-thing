...
<template>
  <div class="flex h-full flex-col rounded-lg border">
    ...
    <UiSeparator />
    <UiTabs default-value="complete" class="flex-1">
      <div class="container h-full py-6">
        <div class="grid h-full items-stretch gap-6 md:grid-cols-[minmax(0,1fr)_200px]">
          <div class="hidden flex-col space-y-4 sm:flex md:order-2">
            <div class="grid gap-2">
              <UiHoverCard :open-delay="200">
                ...
                <UiHoverCardContent class="w-[320px] text-sm" side="left">
          ...
          <div class="md:order-1">
            <UiTabsContent value="complete" class="mt-0 border-0 p-0">
            ...
            <UiTabsContent value="insert" class="mt-0 border-0 p-0">
            ...
            <UiTabsContent value="edit" class="mt-0 border-0 p-0">
              <div class="flex flex-col space-y-4">
                <div class="grid h-full gap-6 lg:grid-cols-2">
                  <div class="flex flex-col space-y-4">
                    <div class="flex flex-1 flex-col space-y-2">
                      <UiLabel class="sr-only" for="input">Input</UiLabel>
                      <UiTextarea
                        id="input"
                    ...
                    <div class="flex flex-col space-y-2">
                      <UiLabel class="sr-only" for="instructions">Instructions</UiLabel>
