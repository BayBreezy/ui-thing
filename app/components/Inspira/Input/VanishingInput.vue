...
<script setup lang="ts">
  ...
  interface Props {
    /**
     * An array of placeholder strings to display in the input.
     *
     * @default ["Placeholder 1", "Placeholder 2", "Placeholder 3"]
     */
    placeholders?: string[];
    /**
     * The interval time in milliseconds for rotating placeholders.
     *
     * @default 3000
     */
    ...
    /**
     * Whether the value should be cleared after submission with the vanishing effect.
     *
     * @default true
     */
    vanishAfterSubmit?: boolean;
  }
