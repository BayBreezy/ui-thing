...
<script lang="ts">
  ...
  type NuxtLinkCustomProps = {
    /** Route Location the link should navigate to when clicked on. */
    to?: RouteLocationRaw;
    /** An alias for `to`. If used with `to`, `href` will be ignored. */
    href?: string;
    /**
     * Forces the link to be considered as external (true) or internal (false). This is helpful to
     * handle edge-cases.
     */
    external?: boolean;
    ...
    /**
     * A rel attribute value to apply on the link. Defaults to "noopener noreferrer" for external
     * links.
     */
    ...
    prefetch?: boolean;
    /**
     * Allows controlling when to prefetch links. By default, prefetch is triggered only on
     * visibility.
     */
    prefetchOn?:
      | "visibility"
  ...
  export type ButtonProps = Partial<NuxtLinkCustomProps> & {
