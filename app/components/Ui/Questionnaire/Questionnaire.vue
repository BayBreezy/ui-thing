<template>
  <form
    ...
    :class="questionnaireStyles({ class: normalizeClass(props.class) || undefined })"
...
<script lang="ts">
  ...
  export const questionnaireStyles = tv({
  ...
  export type QuestionnaireProps = {
    ...
    /** The item shown first. Ignored when `item` is provided. */
    defaultItem?: string;
