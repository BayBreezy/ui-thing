<template>
  <div
    class="bg-background text-foreground min-h-screen [--color-primary:#0ea5e9] [--primary:#0ea5e9] [--radius:12px] [--ring:#0ea5e9]"
  >
    <!-- Import CSV dialog -->
              ...
              <UiDropdownMenuContent align="end" class="w-52">
                <UiDropdownMenuLabel>
                  <div class="flex flex-col">
                    ...
                    <p class="text-muted-foreground text-xs">sienna@ui-thing.com</p>
                  </div>
                </UiDropdownMenuLabel>
                <UiDropdownMenuSeparator />
...
<script lang="ts" setup>
  ...
  // ─── Table columns ─────────────────────────────────────────────────────────────
  const companyColumns: ColumnDef<TanStackTableFeatures, CompanyRow>[] = [
    {
      id: "select",
      header: "",
      enableSorting: false,
