...
<script setup lang="ts">
   ...
   *
   * This component allows you to import code snippets from your project files or external URLs and
   * display them with syntax highlighting. Useful for documentation where you want to show actual
   * source code without duplicating content.
   *
   * @example
   *   ```mdc
  ...
  const props = withDefaults(
    defineProps<{
      /**
       * Relative path to a file in your project to import Must match a pattern in the
       * import.meta.glob array.
       *
       * @example
   ...
   *
   * ⚠️ PERFORMANCE WARNING: Using broad patterns like '/app/**' will bundle ALL matching files into
   * your build, significantly increasing bundle size. Be as specific as possible with your
   * patterns.
   *
   * For a large app, consider:
   *
   * 1. Only glob specific directories you need (e.g., '/app/components/**' instead of '/app/**')
   * 2. Use specific file extensions (e.g., '_.vue' instead of '_')
  ...
  const rawFiles = import.meta.glob(
    [
      ...
      "~/components/content/Block/**/*.vue",
      "~/composables/**/*",
      "~/assets/css/**/*",
      "~/components/Ui/Meteors.client.vue",
      "~/components/Ui/Tiptap.vue",
    ],
    {
      query: "?raw",
      import: "default",
